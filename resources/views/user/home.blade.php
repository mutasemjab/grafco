...
<section class="hero-slider" data-slider>
    ...
    <div class="hero-slide {{ $index === 0 ? 'is-active' : '' }}" style="background-image:url('{{ asset('assets/admin/uploads/' . $banner->photo) }}')">
        ...
        <div class="container hero-inner">
            ...
            <p class="hero-sub">{!! $locale === 'ar' ? $banner->description_ar : $banner->description_en !!}</p>
            <div class="hero-cta">
    ...
    <div class="brands-viewport">
      <div class="brands-track" data-track>
        @foreach($brands as $brand)
          <div class="brand-item"><img src="{{ asset('assets/admin/uploads/' . $brand->photo) }}" alt="brand"></div>
        @endforeach
      </div>
    </div>
...
@if($bottomSection)
<section class="about-hero" style="background-image:url('{{ asset('assets/admin/uploads/' . $bottomSection->photo) }}')">
  <div class="about-hero__overlay"></div>
  <div class="container about-hero__grid">
    <div class="about-hero__left">
      <h2 class="about-hero__title">{{ $locale === 'ar' ? $bottomSection->name_ar : $bottomSection->name_en }}</h2>
