@extends('layouts.app')
@section('title', __('front.contact') . ' | graphco')

@section('content')
<section class="contact-page">
    <div class="container">
        <h1 class="contact-title">{{ __('front.get_in_touch') }}</h1>
        <p class="contact-lead">
            {{ __('front.contact_intro') }}
        </p>
        ...
        <div class="contact-layout">
            <div class="contact-main" data-contact>
                <div class="contact-tabs">
                    <button class="contact-tab is-active" data-form="sales" data-btn="{{ __('front.send_message') }}" data-product="0">
                        {{ __('front.request_sales_call') }}
                    </button>
                    <button class="contact-tab" data-form="tech" data-btn="{{ __('front.request_quote') }}" data-product="1">
                        {{ __('front.report_technical_issue') }}
                    </button>
                </div>
                    ...
                    <form class="contact-form" action="{{ route('contacts.store') }}" method="POST">
                        ...
                        <div class="contact-row">
                            ...
                            <div class="contact-col">
                                ...
                                <select class="contact-input @error('country') is-invalid @enderror" name="country" required>
                                    ...
                                    <option value="Other" {{ old('country') == 'Other' ? 'selected' : '' }}>{{ __('front.other') }}</option>
                                </select>
                                @error('country')
                                    <span class="text-danger" style="font-size: 14px; color: #dc3545;">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="contact-row">
                            <div class="contact-col full">
                                ...
                                <textarea class="contact-input contact-textarea @error('message') is-invalid @enderror" name="message" placeholder="{{ __('front.please_leave_message') }}" required>{{ old('message') }}</textarea>
                                @error('message')
                                    <span class="text-danger" style="font-size: 14px; color: #dc3545;">{{ $message }}</span>
                                @enderror
                            </div>
