...
@section('content')
<div class="container">
    <h3 class="mb-4">{{ __('messages.create_section') }}</h3>

    <form action="{{ route('service-page-sections.store') }}" method="POST" enctype="multipart/form-data" class="card p-4 shadow-sm">
        @csrf
        ...
        <div class="form-group">
            ...
            <select name="service_page_id" class="form-control @error('service_page_id') is-invalid @enderror" required>
                ...
                @foreach($servicePages as $page)
                    <option value="{{ $page->id }}" {{ old('service_page_id') == $page->id ? 'selected' : '' }}>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <div class="form-check mt-2">
                        <input type="checkbox" name="image_right" class="form-check-input" id="image_right" {{ old('image_right') ? 'checked' : '' }}>
