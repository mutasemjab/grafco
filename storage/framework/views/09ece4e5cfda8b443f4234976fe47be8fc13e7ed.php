<section class="contact-page" style="padding: 40px 0;">
    <div class="container">
        <h2 class="contact-title"><?php echo e(__('front.book_appointment')); ?></h2>
        <p class="contact-lead">
            <?php echo e(__('front.appointment_intro')); ?>

        </p>

        <?php if(session('appointment_success')): ?>
            <div class="alert alert-success mb-4" style="padding: 15px; background: #d4edda; border: 1px solid #c3e6cb; border-radius: 8px; color: #155724; margin-bottom: 20px;">
                <?php echo e(session('appointment_success')); ?>
        ...
        <div class="contact-layout">
            <div class="contact-main" data-contact>
                <div class="contact-tabs">
                    <button class="contact-tab is-active" data-form="general" data-btn="<?php echo e(__('front.send_message')); ?>" data-product="0">
                        <?php echo e(__('front.general_inquiry')); ?>

                    </button>
                    <button class="contact-tab" data-form="quote" data-btn="<?php echo e(__('front.request_quote')); ?>" data-product="1">
                        <?php echo e(__('front.request_quote')); ?>

                    </button>
                </div>

                <div class="contact-body">
                    <form class="contact-form" action="<?php echo e(route('appointments.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="contact-row contact-row-extra" data-extra="product" style="display: none;">
                            <div class="contact-col full">
                                ...
                                <select class="contact-input" name="product_category">
                                    ...
                                    <option value="Printers"><?php echo e(__('front.printers')); ?></option>
                                    <option value="Cutters"><?php echo e(__('front.cutters')); ?></option>
                                    <option value="Finishing"><?php echo e(__('front.finishing')); ?></option>
                                </select>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>" name="message" placeholder="<?php echo e(__('front.please_leave_message')); ?>"><?php echo e(old('message')); ?></textarea>
...
</script><?php /**PATH /home/u215380673/domains/glovana.net/public_html/grafco/resources/views/partials/appointment-form.blade.php ENDPATH**/ ?>