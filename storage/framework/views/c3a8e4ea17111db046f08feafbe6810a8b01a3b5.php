                        ...
                        <div class="contact-row contact-row-extra" data-extra="product" style="display: none;">
                            <div class="contact-col full">
                                ...
                                <select class="contact-input" name="product_category">
                                    ...
                                    <option value="Printers" <?php echo e(old('product_category') == 'Printers' ? 'selected' : ''); ?>><?php echo e(__('front.printers')); ?></option>
                                    <option value="Cutters" <?php echo e(old('product_category') == 'Cutters' ? 'selected' : ''); ?>><?php echo e(__('front.cutters')); ?></option>
                                    <option value="Finishing" <?php echo e(old('product_category') == 'Finishing' ? 'selected' : ''); ?>><?php echo e(__('front.finishing')); ?></option>
                                </select>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215380673/domains/glovana.net/public_html/grafco/resources/views/user/contact.blade.php ENDPATH**/ ?>