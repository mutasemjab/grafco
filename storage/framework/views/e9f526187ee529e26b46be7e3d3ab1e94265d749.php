...
unset($__errorArgs, $__bag); ?>" id="description_en"
                                name="description_en" rows="5" required><?php echo e(old('description_en', $banner->description_en)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="description_ar"
                                name="description_ar" rows="5" required><?php echo e(old('description_ar', $banner->description_ar)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <?php if($banner->photo): ?>
                        <div class="mb-2">
                            <img src="<?php echo e(asset('assets/admin/uploads/' . $banner->photo)); ?>" alt="Current Photo"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215380673/domains/glovana.net/public_html/grafco/resources/views/admin/banners/edit.blade.php ENDPATH**/ ?>