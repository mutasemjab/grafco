...
<div class="card shadow-sm">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo e(route('consumable_products.store')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text" name="name_en" value="<?php echo e(old('name_en')); ?>">
...
unset($__errorArgs, $__bag); ?>" type="text" name="name_ar" value="<?php echo e(old('name_ar')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="consumable_id">
                    <option value=""><?php echo e(__('messages.select_consumable')); ?></option>
                    ...
                    <option value="<?php echo e($c->id); ?>" <?php echo e(old('consumable_id') == $c->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\grafco\resources\views/admin/consumable_products/create.blade.php ENDPATH**/ ?>