                ...
                <div class="pdetail-panel" data-panel="download">
                    ...
                    <div class="pdetail-downloads-grid">
                        ...
                        <div class="pdetail-download-card">
                            ...
                            <a href="<?php echo e(asset('assets/admin/uploads/' . $download->file_path)); ?>" download class="pdetail-download-btn">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215380673/domains/glovana.net/public_html/grafco/resources/views/user/product-details.blade.php ENDPATH**/ ?>