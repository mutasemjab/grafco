...
<section class="hero-slider" data-slider>
    ...
    <div class="hero-slide <?php echo e($index === 0 ? 'is-active' : ''); ?>" style="background-image:url('<?php echo e(asset('assets/admin/uploads/' . $banner->photo)); ?>')">
        ...
        <div class="container hero-inner">
            ...
            <p class="hero-sub"><?php echo $locale === 'ar' ? $banner->description_ar : $banner->description_en; ?></p>
            <div class="hero-cta">
                <a href="<?php echo e(route('products.category')); ?>" class="btn-cta"><?php echo e(__('front.our_products')); ?>

                    <svg width="18" height="18" viewBox="0 0 24 24"><path d="M5 12h12M13 6l6 6-6 6" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </a>
                <div class="call-chip">
                    <span class="chip-ico">
                        <svg width="20" height="20" viewBox="0 0 24 24"><path d="M6.6 10.8c1.3 2.5 3.3 4.5 5.8 5.8l2-2c.3-.3.8-.4 1.1-.2 1.2.4 2.5.6 3.9.6.5 0 .9.4.9.9v3.4c0 .5-.4.9-.9.9C10.6 21.9 2.1 13.4 2.1 2.9c0-.5.4-.9.9-.9H7c.5 0 .9.4.9.9 0 1.3.2 2.6.6 3.9.1.4 0 .8-.3 1.1l-1.6 1.6Z" fill="#fff"/></svg>
                    </span>
                    <div class="chip-txt">
            ...
            <div class="featured-arrows">
                <button class="featured-arrow" data-prev type="button" aria-label="<?php echo e(__('messages.previous')); ?>">
                    <svg width="20" height="20" viewBox="0 0 24 24">
                        <path d="M15 6l-6 6 6 6" fill="none" stroke="#665D99" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </button>
...
<section class="brands" data-brands>
  <div class="container brands-head">
    ...
    <p class="brands-sub">Pellentesque etiam blandit in tincidunt at donec. Eget ipsum dignissim placerat nisi, adipiscing mauris non purus parturient.</p>
  </div>


  <div class="brands-wrap">
    <button class="brands-nav" data-prev type="button">
      <svg width="20" height="20" viewBox="0 0 24 24"><path d="M15 6l-6 6 6 6" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </button>

    <div class="brands-viewport">
      <div class="brands-track" data-track>
        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="brand-item"><img src="<?php echo e(asset('assets/admin/uploads/' . $brand->photo)); ?>" alt="brand"></div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    </div>

    <button class="brands-nav" data-next type="button">
      <svg width="20" height="20" viewBox="0 0 24 24"><path d="M9 6l6 6-6 6" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </button>
  </div>
</section>
...
<section class="about-hero" style="background-image:url('<?php echo e(asset('assets/admin/uploads/' . $bottomSection->photo)); ?>')">
  <div class="about-hero__overlay"></div>
  <div class="container about-hero__grid">
    <div class="about-hero__left">
      <h2 class="about-hero__title"><?php echo e($locale === 'ar' ? $bottomSection->name_ar : $bottomSection->name_en); ?></h2>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215380673/domains/glovana.net/public_html/grafco/resources/views/user/home.blade.php ENDPATH**/ ?>